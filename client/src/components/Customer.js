        ...
        Axios.get("http://localhost:3005/vehicle/vehDetails").then((response) => {
            ...
            setVehList(
                response.data.map((val) => {
                    ...
                    return { value: val.vehid, text: "Animal: " + val.model };
                })
            );
        });
    }, []);
    ...
    return (
        <div>
            ...
            <div className='profile book'>
                ...
                <div class='head'><h2>Book a Appointment</h2></div>
                <div className='book'>
                    <div >
                        <br></br>
                        <br></br>
                        <label>Animal </label>
                        <br></br>
                        <label>Select Animal for which you want to consult</label>
                        <br></br>
                        <div><select value={vehId} onChange={handleChange}>
                            <option values={vehId}>Select Animal</option>
                            {vehList.map(option => (
                    ...
                    <br></br>
                    <br></br>
                    <button onClick={bookTestDrive}>Book Appointment</button>
